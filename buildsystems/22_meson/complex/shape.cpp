...
Triangle::Triangle(const Point& a, const Point& b, const Point& c, uint16_t id): Shape(id), a(a), b(b), c(c) {};
...
Quad::Quad(const Point& a, const Point& b, const Point& c, const Point& d, uint16_t id): Shape(id), a(a), b(b), c(c), d(d) {};
